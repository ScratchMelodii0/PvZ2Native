...
public class Session implements Serializable {
    ...
    void extendAccessTokenIfNeeded() throws Throwable {
        if (shouldExtendAccessToken()) {
            extendAccessToken();
        }
    }

    void extendAccessToken() throws Throwable {
    ...
    class TokenRefreshRequest implements ServiceConnection {
        ...
        public void bind() {
            ...
            if (intent != null && Session.staticContext.bindService(intent, Session.this.new TokenRefreshRequest(), 1)) {
    ...
    public static final class OpenRequest extends AuthorizationRequest {
        ...
        public /* bridge */ /* synthetic */ AuthorizationRequest setPermissions(List x0) {
            return setPermissions((List<String>) x0);
        }
