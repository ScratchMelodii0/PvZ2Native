...
public interface b extends IInterface {
    ...
    public static abstract class a extends Binder implements b {
        ...
        public static b O(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof b)) ? new C0051a(iBinder) : (b) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case IDownloaderClient.STATE_FAILED_SDCARD_FULL /* 17 */:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    boolean zA = a(O(parcel.readStrongBinder()));
                    parcel2.writeNoException();
