...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IPolylineDelegate {
        ...
        private static class C0048a implements IPolylineDelegate {
            private IBinder a;
        ...
        public static IPolylineDelegate S(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IPolylineDelegate)) ? new C0048a(iBinder) : (IPolylineDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case IDownloaderClient.STATE_FAILED_UNLICENSED /* 15 */:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    boolean zEqualsRemote = equalsRemote(S(parcel.readStrongBinder()));
                    parcel2.writeNoException();
