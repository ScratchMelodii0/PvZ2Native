...
public interface f extends IInterface {
    ...
    public static abstract class a extends Binder implements f {
        ...
        public static f T(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof f)) ? new C0055a(iBinder) : (f) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 8:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    boolean zA = a(T(parcel.readStrongBinder()));
                    parcel2.writeNoException();
