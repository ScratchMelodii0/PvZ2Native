...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IProjectionDelegate {
        ...
        private static class C0033a implements IProjectionDelegate {
            private IBinder a;
        ...
        public static IProjectionDelegate K(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IProjectionDelegate)) ? new C0033a(iBinder) : (IProjectionDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    LatLng latLngFromScreenLocation = fromScreenLocation(b.a.l(data.readStrongBinder()));
