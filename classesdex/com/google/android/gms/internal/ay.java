...
public interface ay extends IInterface {
    ...
    public static abstract class a extends Binder implements ay {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.ay$a$a, reason: collision with other inner class name */
        private static class C0006a implements ay {
            private IBinder a;
        ...
        public static ay n(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ay)) ? new C0006a(iBinder) : (ay) iInterfaceQueryLocalInterface;
        }
