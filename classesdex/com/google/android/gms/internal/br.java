...
public interface br extends IInterface {
    ...
    public static abstract class a extends Binder implements br {
        ...
        private static class C0014a implements br {
            private IBinder a;
        ...
        public static br aa(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof br)) ? new C0014a(iBinder) : (br) iInterfaceQueryLocalInterface;
        }
