...
public interface be extends IInterface {
    ...
    public static abstract class a extends Binder implements be {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.be$a$a, reason: collision with other inner class name */
        private static class C0008a implements be {
            private IBinder a;
        ...
        public static be q(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof be)) ? new C0008a(iBinder) : (be) iInterfaceQueryLocalInterface;
        }
