...
public interface bl extends IInterface {
    ...
    public static abstract class a extends Binder implements bl {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.bl$a$a, reason: collision with other inner class name */
        private static class C0010a implements bl {
            private IBinder a;
        ...
        public static bl V(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof bl)) ? new C0010a(iBinder) : (bl) iInterfaceQueryLocalInterface;
        }
